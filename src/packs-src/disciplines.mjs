...
const powers = [
  ...
  Power({ disc: "bloodSorcery", name: "Baal's Caress", level: 5, cost: "One Rouse Check", pool: "Resolve + Blood Sorcery", opp: "Stamina + Composure", desc: "Boil a victim's blood in their veins, inflicting grievous harm." }),
  ...
  Power({ disc: "obfuscate", name: "Ghost in the Machine", level: 3, cost: "One Rouse Check", amalgam: AM("auspex", 1), desc: "Extend your concealment to fool cameras and recording devices." }),
  ...
  Power({ disc: "presence", name: "Irresistible Voice", level: 4, cost: "Free", amalgam: AM("dominate", 1), desc: "Make your spoken Dominate commands need only your voice to land." }),
